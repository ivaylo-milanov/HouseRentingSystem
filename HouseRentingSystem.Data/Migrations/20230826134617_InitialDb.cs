    ...
    public partial class InitialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "agent id"),
                    PhoneNumber = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false, comment: "agent phone number"),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "agent  user id")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "house id"),
                    ...
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "house category id"),
                    AgentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "house agent id"),
                    RenterId = table.Column<Guid>(type: "uniqueidentifier", nullable: true, comment: "house renter id")
                },
                constraints: table =>
                {
